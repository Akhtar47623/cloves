            ...
            <div class="row d-flex">
                <div class="col-lg-7">
                     <form action="{{ route('register') }}" id="RegisterForm" method="POST">
                        ...
                        <input type="text" name="userRole" id="address" hidden="" value="user">
                        <div class="log-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <input type="email" name="reg_email" placeholder="Email Address" class="wow fadeIn form-control" data-wow-delay=".65s" value="{{old('email')}}" id="reg_email">
                                    @error('email')
                                        <span class="text-danger mx-4">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                              <div class="col">
                                <input type="password" name="reg_password" placeholder="Password" class="wow fadeIn form-control" data-wow-delay=".85s" id="reg_password">
                                  @error('reg_password')
                                    <span class="text-danger mx-4">{{$message}}</span>
                                  @enderror
                              </div>
                          ...
                          <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <button type="button" class="btn btn-success" id="modal_btn" data-dismiss="modal">Save</button>
                              </div>
                            </div>
                          </div>
                        </div>
