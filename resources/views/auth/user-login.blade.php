                ...
                <div class="col-lg-7">
                   <form action="javascript:void(0)" method="POST" id="LoginForm">
                        ...
                        <div class="log-form">
                            ...
                            <!--         <span class="login-box"> no account? &nbsp;<a href="{{route('Login')}}" data-toggle="modal" data-target="#largeModal" class="text-danger">Register</a></span> -->
                                      <span class="login-box"> no account? &nbsp;<a href="{{route('vendorRegisterPage')}}" class="text-danger">Register</a></span>
