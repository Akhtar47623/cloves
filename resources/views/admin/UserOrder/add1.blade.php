                ...
                <div class="card-body">
                    <div class="d-flex m-b-10 no-block">
                        ...
                        <form class="ml-2 mr-2" action="{{url('/admin/depot-location/')}}" method="POST" enctype="multipart/data">
                            @csrf
                            <div class="row">
                                <input type="text"  name="" id="depotLong">
                                <input type="text" name="" id="depotLat" >
...
@push('js')
    ...
    <script>
        ...
        $(document).ready(function(){
            $("div#geocoder input.mapboxgl-ctrl-geocoder--input").attr('placeholder','');
        ...
        function changeRadius() {
            ...
            var distanceInKilometer=radius*1000;
