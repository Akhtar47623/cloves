        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{url('/admin/why-choose-us/'.$why_choose_us->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="form-group">
                            <label for="title">Title:</label>
                            <input type="text" class="form-control" id="title" name="title" value="{{ $why_choose_us->title }}">
                            @error('title')
                        ...
                        <!--  <div class="form-group">
                            ...
                            $why_choose_us->short_description }}">{{$why_choose_us->short_description }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3">{{ $why_choose_us->description }}</textarea>
                            @error('description')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <img style="max-width: 340px;" id="input-preview" src="{{ isset($why_choose_us)?asset($why_choose_us->image_path):asset('services_images/upload.jpg') }}">
