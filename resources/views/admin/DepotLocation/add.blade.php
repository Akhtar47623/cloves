            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive m-t-10 p-2">
                        <form class="ml-2 mr-2" action="{{url('/admin/depot-location/')}}" method="POST" enctype="multipart/data">
                            @csrf
                            <div class="row">
                                <input type="hidden" value="" name="" id="depotLong">
                                <input type="hidden" name="" id="depotLat" value="">
                            <div id="mapid" style="width: 100%; height: 500px;"></div>
                                <input type="number" name="radius" value="" min="0" class="p-1" id="radius" placeholder="Distance in Miles" oninput="changeRadius(); validity.valid || (value = this.previousValue)">
                               <input type="text" name="depot_long" id="sourceLong" onchange="myFunction()" >
                               <input type="text" name="depot_lat" id="sourceLat" onchange="myFunction()" >
                               <input type="text" name="depotLoc" id="depotLoc">
                            </div>
...
<script>
    ...
    $(document).ready(function(){
        $("div#geocoder input.mapboxgl-ctrl-geocoder--input").attr('placeholder','Your Depot Location');
    });
    // SET PLACEHOLDER
