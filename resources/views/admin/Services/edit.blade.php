                    ...
                    <form action="{{url('/admin/services/'.$services->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" id="long_description" name="long_description">{{$services->long_description }}</textarea>
                        ...
                        <div class="form-group">
                            <label for="image">Image 1(Home Page):</label>
                          ...
                          <div class="form-group">
                            <label for="image">Image 2(Service Page):</label>
                            <img style="max-width: 340px;" id="input-preview" src="{{ isset($services)?asset($services->image1):asset('services_images/upload.jpg') }}">
                            <div class="upload-photo">
                                <input type="file" name="image1" id="input-file-now" class="dropify" /></br>
                                @error('image1')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
