                ...
                <div class="card-body">
                    ...
                    <form action="{{url('/admin/product')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="Name" name="Name"  placeholder="Add Item Name"  value="{{old('Name')}}">
                            @error('Name')
                        ...
                        <div class="row">
                            <div class=" col-4 form-group">
                                ...
                                <input type="number" class="form-control" id="PurchaseCost" name="PurchaseCost"  placeholder="Add Item Cost"  value="{{old('PurchaseCost')}}">
                                @error('PurchaseCost')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                             <div class=" col-4 form-group">
                                ...
                                <input type="number" class="form-control" id="UnitPrice" name="UnitPrice"  placeholder="Add Item Sales Price"  value="{{old('UnitPrice')}}">
                                @error('UnitPrice')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                             <div class=" col-4 form-group">
                                ...
                                <input type="number" class="form-control" id="QtyOnHand" name="QtyOnHand"  placeholder="Add Item Quantity"  value="{{old('QtyOnHand')}}">
                                @error('QtyOnHand')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="Description" name="Description"  placeholder="Add Item Description"  value="{{old('Description')}}">
                            @error('Description')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
