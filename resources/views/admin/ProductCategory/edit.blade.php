            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex m-b-10 no-block">
                        <h5 class="card-title m-b-0 align-self-center">Update Category</h5>
                    ...
                    <form action="{{url('/admin/product-category/'.$categories->Id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="form-group">
                            <label for="category">Category:</label>
                            <input type="text" name="id" value="{{$categories->Id}}" hidden>
                            <input type="text" name="SyncToken" value="{{$categories->SyncToken}}" hidden>
                            <input type="text" class="form-control" id="category" name="category" value="{{ $categories->Name }}">
                            @error('category')
