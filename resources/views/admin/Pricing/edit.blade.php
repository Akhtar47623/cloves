            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex m-b-10 no-block">
                        ...
                        <form class="ml-2 mr-2" action="{{url('/admin/pricing/'.$prices->id)}}" method="POST" enctype="multipart/data">
                            @csrf
                             @method('put')
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-6 mt-3">
                                    ...
                                    <p>{{$prices->destination_location}}</p>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <input type="number" class="form-control p-2" name="shipping_price" id="shipping_price" placeholder="" min="0" value="{{$prices->shipping_price}}">
                                ...
                                <div class="col-4">
                                    ...
                                    <input class="form-control p-2" type="text" name="total_distance" id="distance" placeholder="Distance in Kilometer" readonly="">
                                </div>
                                <div class="col-4">
                                    <label>Total Amount</label>
                                    <input class="form-control p-2" type="text" name="total_amount" id="price" placeholder="Total Amount" readonly="">
                                </div>
                            </div>
