            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex m-b-10 no-block">
                        <h5 class="card-title m-b-0 align-self-center">Membership</h5>
                        <div class="ml-auto text-light-blue">
                            <ul class="nav nav-tabs customtab default-customtab list-inline text-uppercase lp-5 font-medium font-12" role="tablist">
                                <li>
                                    <a href="{{url('admin/membership/create/')}}" class="btn waves-effect waves-light btn-rounded btn-primary">Add Membership</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <table id="myTable" class="table color-table table-bordered product-table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <!-- <td>{{ $item->link }}</td> -->
                                    <td><img src="{{ asset($item->image_path) }}" class="img-responsive"></td>
                                    @if($item->status == 1)
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ url('/admin/membership/'.$item->id) }}"><i class="fas fa-eye"></i></a>
                                           <a href="{{ url('admin/membership/'.$item->id.'/edit/') }}"><i class="fas fa-edit"></i></a>
                                        <form style="display: inline-block;" method="POST" action="{{ url('/admin/membership',$item->id) }}">
                                                @csrf
                                                @method('DELETE')
