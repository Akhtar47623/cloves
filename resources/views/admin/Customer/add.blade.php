            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex m-b-10 no-block">
                        <h5 class="card-title m-b-0 align-self-center">Add Customer</h5>
                    ...
                    <form action="{{url('/admin/customer')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <!-- <div class="form-group">
                            ...
                            <input class="form-control" id="news_dcription" name="Address" rows="3" placeholder="Email">
                            @error('Address')
                            <p class="error-message">**{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label for="TotalAmt">Amount:</label>
                            <input type="text" class="form-control" id="TotalAmt" name="TotalAmt"  placeholder="Amount">
                            @error('TotalAmt')
                            <p class="error-message">**{{ $message }}</p>
                            @enderror
                        </div> -->
