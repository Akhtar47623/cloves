                ...
                <div class="card-body">
                    ...
                    <form action="{{url('/admin/invoice/'.$invoice->Id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="Address" name="Address" value="{{$invoice->BillEmailCc->Address}}">
                        </div>
                        <div class="form-group">
                            <label for="City">City:</label>
                            <input class="form-control" id="City" name="City" rows="3" value="{{$invoice->BillAddr->City}}">
                        </div>
                        <div class="form-group">
                            <label for="TotalAmt">Total Amount:</label>
                            <input type="text" class="form-control" id="TotalAmt" name="TotalAmt" value="{{ $invoice->TotalAmt }}">
                        </div>
