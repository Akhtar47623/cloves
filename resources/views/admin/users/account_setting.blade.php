                ...
                <div class="white-box card">
                    <div class="card-body">
                        ...
                        @elseif(auth()->user()->hasRole('vendor'))
                         <form id="commentForm" action="{{url('vendor/account/profile')}}"
                              method="POST" enctype="multipart/form-data">
                        @endif
                            ...
                            <div id="rootwizard">
                                <ul class="nav nav-tabs pb-2" id="tabs" role="tablist">
                                    <li class="nav-link  "><a href="#tab1" class="active" data-toggle="tab">User Profile</a></li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab1">
                                        ...
                                        <div class="form-group row justify-content-center   {{ $errors->first('name', 'has-error') }}">
                                            ...
                                            <div class="col-12 col-lg-6">
                                                ...
                                                <input id="name" name="name" type="text" placeholder="Name" class="form-control required" value="{{$user->organization}}"/>
                                                {!! $errors->first('name', '<span class="help-block">:message</span>') !!}
                                                @elseif(auth()->user()->hasRole('user'))
                                                <input id="name" name="name" type="text" placeholder="Name" class="form-control required" value="{{$user->fname}}"/>
                                                {!! $errors->first('name', '<span class="help-block">:message</span>') !!}
                                                    ...
                                                    <div class="fileinput-new thumbnail"
                                                        ...
                                                        @if(!empty($user->profile->pic))
                                                            <img src="{{asset('storage/uploads/users/'.$user->profile->pic)}}"
                                                                 alt="profile pic">
                                                        @else
                                                            <img src="{{asset('storage/uploads/users/no-avatar.png')}}" alt="profile pic">
                                                        @endif
                                                    </div>
                                    ...
                                    <div class="col-12 text-center">
                                        <ul class="pager wizard d-inline-block w-75 mx-auto my-0 ">
                                            ...
                                            <li class="next float-right finish" style="display:none;"><a class="border btn btn-outline" href="javascript:;">Finish</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
