        ...
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{url('/admin')}}">
                    <!-- <h2>{{ getImage() }}</h2> -->
                <img src="{{asset(getImage())}}" style=" width: 220px; " alt="{{env('APP_NAME')}}" class="dark-logo"/></a>
            </div>
            <div class="top-bar-main">
                <div class="float-left">
                    <!-- <a href="{{route('admin.quickbook.connect')}}">Connect to quickbook</a> -->
              <!--       <ul class="navbar-nav">
                        <li class="nav-item">
                        ...
                        @forelse(auth()->user()->unreadNotifications->take(5) as $notification)
                            <div class="notifications-item d-none"> 
                                <div class="text">
                                ...
                                <ul class="dropdown-user">
                                    <li class="text-center">
                                        <div class="dw-user-box">
                                            <div class="u-img">
                                                @if(empty(auth()->user()->profile->pic))
                                                <img src="{{asset('storage/uploads/users/no-avatar.png')}}"
                                                     alt="user-img"
                                                >
                                                @else
                                                <img src="{{asset('storage/uploads/users/'.auth()->user()->profile->pic)}}" alt="user-img">
                                    ...
                                    <li><a href="{{url('vendor/account/profile')}}"><i class="fas fa-user mr-1"></i> My Profile</a>
                                    </li>
                                    @endif
