...
class ServicesContentController extends Controller
{
    ...
    {
        $services = CMS::where('page_section','Services')->get();
        return view('admin.CMS.Services.index',compact('services'));
    }
    public function edit($id)
    {
        $services = CMS::findOrFail($id);
        return view('admin.CMS.Services.edit',compact('services'));
    }

    public function show($id)
    {
        $services = CMS::findOrFail($id);
        return view('admin.CMS.Services.view',compact('services'));
    }
    ...
    public function update(Request $request , $id)
    {
        ...
        return redirect('/admin/services-content')->with('message', 'Content Has Been Updated!');
    }
