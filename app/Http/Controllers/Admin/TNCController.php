...
class TNCController extends Controller
{
    ...
    {
        $tns_cms = CMS::where('page_section','Terms & Conditions')->get();
        return view('admin.CMS.TNC.index',compact('tns_cms'));
    }
    public function edit($id)
    {
        $tns_cms = CMS::findOrFail($id);
        return view('admin.CMS.TNC.edit',compact('tns_cms'));
    }

    public function show($id)
    {
        $tns_cms = CMS::findOrFail($id);
        return view('admin.CMS.TNC.view',compact('tns_cms'));
    }
    ...
    public function update(Request $request , $id)
    {
        ...
        return redirect('/admin/terms-conditions')->with('message', 'Content Has Been Updated!');
    }
