...
class PartnerContentController extends Controller
{
    ...
    {
        $partner_cms = CMS::where('page_name','Home Page')->get();
        return view('admin.CMS.Partner.index',compact('partner_cms'));
    }
    public function edit($id)
    {
        $partner_cms = CMS::findOrFail($id);
        return view('admin.CMS.Partner.edit',compact('partner_cms'));
    }

    public function show($id)
    {
        $partner_cms = CMS::findOrFail($id);
        return view('admin.CMS.Partner.view',compact('partner_cms'));
    }
    ...
    public function update(Request $request , $id)
    {
        ...
        return redirect('/admin/partner-content')->with('message', 'Content Has Been Updated!');
    }
