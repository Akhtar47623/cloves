...
class ContactUsController extends Controller
{
    ...
    {
        $contact_us = CMS::where('page_name','Contact Us')->get();
        return view('admin.CMS.Contact.index',compact('contact_us'));
    }
    public function edit($id)
    {
        $contact_us = CMS::findOrFail($id);
        return view('admin.CMS.Contact.edit',compact('contact_us'));
    }

    public function show($id)
    {
        $contact_us = CMS::findOrFail($id);
        return view('admin.CMS.Contact.view',compact('contact_us'));
    }
