...
class FAQSContentController extends Controller
{
    public function index()
    {
        $faqs_cms = CMS::where('page_section','FAQS')->get();
        return view('admin.CMS.FAQ.index',compact('faqs_cms'));
    }
    public function edit($id)
    {
        $faqs_cms = CMS::findOrFail($id);
        return view('admin.CMS.FAQ.edit',compact('faqs_cms'));
    }

    public function show($id)
    {
        $faqs_cms = CMS::findOrFail($id);
        return view('admin.CMS.FAQ.view',compact('faqs_cms'));
    }
    ...
    public function update(Request $request , $id)
    {
        ...
        return redirect('/admin/faqs-content')->with('message', 'FAQS Content Has Been Updated!');
    }
